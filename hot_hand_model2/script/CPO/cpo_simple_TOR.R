...
library(boot)
library(expm)
source('./script/CPO/posterior_draws_simple_TOR.R') #saved in draws_posterior
...
log_cpo_simple_TOR <- log_cpo


# hist(log_cpo)


save(log_cpo_simple_TOR, 
     file = './results/log_cpo_simple_TOR.RData')
